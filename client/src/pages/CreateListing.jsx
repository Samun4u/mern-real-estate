    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <input type="text" placeholder='Name' className='p-3 rounded-lg border' maxLength="62" minLength='10' id='name' required />
                <textarea type="text" placeholder='Description' className='p-3 rounded-lg border' maxLength="62" minLength='10' id='description' required />
                <input type="text" placeholder='Address' className='p-3 rounded-lg border' maxLength="62" minLength='10' id='address' required />
                ...
                <div className='flex flex-wrap gap-6'>
                    ...
                    <div className='flex items-center gap-2'>
                        <input type="number" className='p-3 border border-gray-300 rounded-lg' id='baths' min="1" max="10" required />
                        <p>Baths</p>
                    </div>
                    <div className='flex items-center gap-2'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    ...
                    <button onClick={handleImageSubmit} className='text-green-700 border p-3 rounded-lg border-green-700 hover:shadow-lg disabled:opacity-80 uppercase'>{ loading ? 'Uploading...' : 'Upload' }</button>
                </div>
                <p className='text-red-700'>{imageUploadError && imageUploadError}</p>
                {
                    formData.imageUrls.length > 0 && formData.imageUrls.map((url,index) => (
                        <div key={url} className='flex justify-between p-3 border items-center'>
                            ...
                            <button onClick={ () => hanldeRemoveImage(index) } className='text-red-700 p-3 uppercase rounded-lg hover:opacity-75'>Delete</button>
                        </div>
                    ))
                }
